...
class PhotoModule(Module):
    ...
    def Advance( self, t1):
        ...
        T1 = self.V_GetRec('T1', ind_get=ind_pho)
        I2 = self.V_GetRec('I2', ind_get=ind_pho)
        V_cmax1 = V_cmax( T_f=T1, V_cmax25=self.V('V_cmax25'), Q10_Vcmax=self.V('Q10_Vcmax'), k_T=self.V('k_T'), k_d=self.V('k_d') )
